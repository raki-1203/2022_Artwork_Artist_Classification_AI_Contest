...
python inference.py --device 1 --output_path_list ./saved_model/image_baseline_vit_base_patch16_384 --predict_path ./predict/image_baseline_vit_base_patch16_384_cv --tta
