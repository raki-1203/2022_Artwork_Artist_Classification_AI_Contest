...
# Image baseline + model vit_base_patch16_224 Cross Validation ->
python train.py --is_train --use_amp --device 0 --epochs 30 --train_batch_size 16 --accumulation_steps 2 --wandb --model_name_or_path vit_base_patch16_224 --output_path ./saved_model/image_baseline_vit_base_patch16_224 --loss WeightedCrossEntropy --beta 1 --cutmix_prob 0.5 --cv --img_size 224
python inference.py --device 1 --output_path_list ./saved_model/image_baseline_vit_base_patch16_224 --predict_path ./predict/image_baseline_vit_base_patch16_224 --tta
python inference.py --device 1 --output_path_list ./saved_model/image_baseline_vit_base_patch16_224 ./saved_model/image_baseline_res2net50_26w_4s ./saved_model/image_baseline_efficientnet_b4 ./saved_model/image_baseline_resnext50_32x4d ./saved_model/image_baseline_convnext_tiny_384_in22ft1k --predict_path ./predict/image_baseline_ensemble_efficientnet_b4_resnext50_32x4d_convnext_tiny_384_in22ft1k_res2net50_26w_4s_vit_base_patch16_224 --tta --ensemble