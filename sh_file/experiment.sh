...
python train.py --is_train --use_amp --device 1 --epochs 30 --train_batch_size 32 --accumulation_steps 1 --wandb --model_name_or_path convnext_tiny_384_in22ft1k --output_path ./saved_model/image_baseline_convnext_tiny_384_in22ft1k --loss WeightedCrossEntropy --beta 1 --cutmix_prob 0.5 --cv
