...
python train.py --is_train --use_amp --device 0 --epochs 30 --train_batch_size 16 --accumulation_steps 2 --wandb --model_name_or_path vit_base_patch16_384 --output_path ./saved_model/image_baseline_vit_base_patch16_384 --loss WeightedCrossEntropy --beta 1 --cutmix_prob 0.5 --cv
