...
python train.py --is_train --use_amp --device 0 --epochs 30 --train_batch_size 32 --accumulation_steps 1 --wandb --model_name_or_path vit_base_patch16_224 --output_path ./saved_model/image_baseline_vit_base_patch16_224 --loss WeightedCrossEntropy --beta 1 --cutmix_prob 0.5 --cv --img_size 224
